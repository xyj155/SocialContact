...
public class SameCityFragment extends BaseFragment<UserPostPresenter> implements UserPostContract.View {
    ...
    public void initData() {
        mPresenter.queryUserPost(String.valueOf(SharePreferenceUtil.getUser("city","String")), "");
