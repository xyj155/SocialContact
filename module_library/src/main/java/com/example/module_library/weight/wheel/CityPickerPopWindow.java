package com.example.module_library.weight.wheel;
...
import com.example.module_library.interfaces.OnWheelChangedListener;
import com.example.module_library.weight.wheel.entity.CityModel;
import com.example.module_library.weight.wheel.entity.DistrictModel;
import com.example.module_library.weight.wheel.entity.ProvinceModel;
...
public class CityPickerPopWindow extends PopupWindow implements OnWheelChangedListener {
    ...
    /**
     */
    private String pickValue = "安徽省 安庆市 枞阳县";
    ...
    public CityPickerPopWindow(Activity context) {
        ...
        ColorDrawable dw = new ColorDrawable(0xFFEE0000);
    ...
    private void updateCities() {
        ...
        ArrayWheelAdapter<String> stringArrayWheelAdapter = new ArrayWheelAdapter<>(mContext, cities);
