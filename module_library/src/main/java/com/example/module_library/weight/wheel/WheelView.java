...
import com.example.module_library.interfaces.ItemsRange;
import com.example.module_library.interfaces.OnWheelChangedListener;
import com.example.module_library.interfaces.OnWheelClickedListener;
import com.example.module_library.interfaces.OnWheelScrollListener;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xFFfafafa,
...
//			0xefffffff, 0xefffffff };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		// 绘制上边直线
		canvas.drawLine(90, center - offset, getWidth()-90, center - offset, paint);
		// 绘制下边直线
		canvas.drawLine(90, center + offset, getWidth()-90, center + offset, paint);
//		//*/
	}
