 ...
 */
public class MPhotoPreviewActivity extends Activity implements ViewPager.OnPageChangeListener, OnClickListener {
    protected List<PhotoEntity> photos = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photos.addAll((List<PhotoEntity>) getIntent().getExtras().getSerializable("photos"));
    ...
    private PagerAdapter mPagerAdapter = new PagerAdapter() {
        ...
        private static final String TAG = "MPhotoPreviewActivity";

        @Override
        public View instantiateItem(final ViewGroup container, final int position) {
            Log.i(TAG, "instantiateItem: " + photos.get(position).getOriginalPath());
            BasePhotoPreview photoPreview = new BasePhotoPreview(MPhotoPreviewActivity.this);
